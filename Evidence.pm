...
sub check_biomarker {
	...
	for ( split /\s*\+\s*/, $biomarker ) {
		return undef if /Microsatellite Instability|Tumour Mutation(?:al)? Burden|(?:Homologous Recombination Deficiency|Loss-of-heterozygosity) Score|Mismatch repair|.*subtype/i;
