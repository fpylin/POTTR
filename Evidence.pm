...
FAM131B FAM135B FAM47C FANCA FANCC FANCD2 FANCE FANCF FANCG FAS FAT1 FAT3 FAT4 FBLN2 FBXO11 FBXW7 FCGR2B FCRL4 FEN1 FES FEV FGFR1 FGFR1OP FGFR2 FGFR3 FGFR4
...
QKI
RABEP1 RAC1 RAD17 RAD21 RAD51B RAF1 RALGDS RANBP2 RAP1GDS1 RARA RB1 RBM10 RBM15 RECQL4 REL RET RFWD3 RGPD3 RGS7 RHOA RHOH RMI2 RNF213 RNF43 
	...
	# 		my $rhs_catype = $tumour_type; # "catype:".$tumour_type;
			...
			for my $rhs_catype (@rhs_catypes) {
				for my $rx (@treatments) {
					...
					push @error_msg, "\e[1;31mERROR: Line $line: ''$rx'' not exist in the database\e[0m" if ( $drug_class_regimen eq 'UNDEF' ) and ! length $normalised_class ;
					
					my $f_no_specific_drug = ( $drug_class_regimen eq 'UNDEF' ) ;
					
					$drug_class_regimen = $normalised_class if $drug_class_regimen eq 'UNDEF' ;
